        ...
        <div class="p-6 bg-white border-b border-gray-200">
          ...
          <form class="mb-6" action="{{ route('schedule.update',$schedule->id) }}" method="POST">
            ...
            <div class="flex flex-col mb-4">
              ...
              <input class="border py-2 px-3 text-grey-darkest" type="datetime-local" name="start" id="start" value="{{$schedule->start}}">
            </div>
            <div class="flex flex-col mb-4">
              <label class="mb-2 uppercase font-bold text-lg text-grey-darkest" for="finish">finish</label>
              <input class="border py-2 px-3 text-grey-darkest" type="datetime-local" name="finish" id="finish" value="{{$schedule->finish}}">
            </div>
